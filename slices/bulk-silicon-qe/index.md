# Bulk-silicon Quantum ESPRESSO slices
...
5. [Wannier localization and validation](wannier-localization-validation/index.md)
6. [Separately authorized execution](authorized-execution/index.md)

Each slice first reaches its gate by deterministic replay. Calculator execution is a later, separately authorized slice.
